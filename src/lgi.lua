...
local function getface(namespace, interface, functions)
	local t = {}
	for _, func in pairs(functions) do
		t[func] = core.get(namespace, interface, func)
	end
	return t
end
...
local gi = {
	IRepository = loadface('GIRepository', 'IRepository', {
		'require', 'find_by_name', 'get_n_infos', 'get_info'
		}),
	IBaseInfo = loadface('GIRepository', 'IBaseInfo', {
